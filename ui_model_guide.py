...
<div style="background:rgba(124,58,237,0.10);border:1px solid rgba(124,58,237,0.3);border-radius:12px;padding:14px 18px;">
  ...
  <div style="margin-top:10px;padding:8px 10px;background:rgba(0,0,0,0.2);border-radius:8px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.67rem;color:#7c3aed;line-height:2.0;">
...
<div style="background:rgba(249,115,22,0.08);border:1px solid rgba(249,115,22,0.25);border-radius:12px;padding:14px 18px;">
  ...
  <div style="margin-top:10px;padding:8px 10px;background:rgba(0,0,0,0.2);border-radius:8px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.67rem;color:#f97316;line-height:2.0;">
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #7c3aed;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:7px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;margin-bottom:8px;">(Q실적 - Q기준) x P기준_fx x ER기준</div>
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #7c3aed;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:6px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;margin-bottom:6px;">(Q실적 - Q기준) x P실적_원화단가</div>
  <div style="font-size:0.62rem;color:#f87171;margin-bottom:2px;font-weight:500;">▼ 수량 감소 시</div>
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:6px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;">(Q실적 - Q기준) x P기준_원화단가</div>
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #0ea5e9;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:7px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;margin-bottom:8px;">(P실적_fx - P기준_fx) x Q실적 x ER기준</div>
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #0ea5e9;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:7px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;margin-bottom:8px;">총차이 - ①수량차이 - ③환율차이</div>
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #10b981;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="background:rgba(0,0,0,0.25);border-radius:6px;padding:7px 10px;font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.72rem;color:#e2e8f0;margin-bottom:8px;">(ER실적 - ER기준) x Q실적 x P실적_fx</div>
...
<div style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-left:3px solid #10b981;border-radius:0 10px 10px 0;padding:12px 14px;margin-bottom:4px;">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-bottom:8px;">
    <div style="background:rgba(0,0,0,0.2);border-radius:5px;padding:5px 8px;">
      ...
      <div style="font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.63rem;color:#64748b;">dER x Q기 x P실_fx</div>
    </div>
    <div style="background:rgba(0,0,0,0.2);border-radius:5px;padding:5px 8px;">
      <div style="font-size:0.6rem;color:#10b981;font-weight:600;margin-bottom:2px;">단가↑ &amp; 수량↓</div>
      <div style="font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.63rem;color:#64748b;">dER x Q실 x P실_fx</div>
    </div>
    <div style="background:rgba(0,0,0,0.2);border-radius:5px;padding:5px 8px;">
      <div style="font-size:0.6rem;color:#10b981;font-weight:600;margin-bottom:2px;">단가↓ &amp; 수량↑</div>
      <div style="font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.63rem;color:#64748b;">dER x Q기 x P기_fx</div>
    </div>
    <div style="background:rgba(0,0,0,0.2);border-radius:5px;padding:5px 8px;">
      <div style="font-size:0.6rem;color:#10b981;font-weight:600;margin-bottom:2px;">단가↓ &amp; 수량↓</div>
      <div style="font-family:'SF Mono','Fira Code','Courier New',monospace;font-size:0.63rem;color:#64748b;">dER x Q실 x P기_fx</div>
    </div>
  </div>
